...
print("증명사진 , 내부촬영 , 야외촬영 , 바디프로필 , 웨딩촬영 등이 있습니다.")
...
while True:
    ...
    if Menu[Choice]:
        ...
        if Choice == 1:
            ...
            if Place == "인천 경기":
                print("인천경기로 출장시 가격추가는 " , only_Subject3_Price[Place] , "이고 최종가격은" , total_price_number3 , "입니다." )
            elif Place == "충청":
                print("충청으로 출장시 가격추가는 " , only_Subject3_Price[Place] , "이고 최종가격은" , total_price_number3 , "입니다." )
            elif Place == "경상":
                print("경상으로 출장시 가격추가는 " , only_Subject3_Price[Place] , "이고 최종가격은" , total_price_number3 , "입니다." )
            elif Place == "호남":
                print("호남으로 출장시 가격추가는 " , only_Subject3_Price[Place] , "이고 최종가격은" , total_price_number3 , "입니다." )
            elif Place == "제주":
                print("제주로 출장시 가격추가는 " , only_Subject3_Price[Place] , "이고 최종가격은" , total_price_number3 , "입니다." )
            else:
                print("서울은 따로 추가금액 있지않습니다!")
            print("야외촬영시 착용할 의상과 신발은 넉넉히 준비를 해오시기 바랍니다. 촬영이 원활하게 진행될시 추가로 컷을 더 가져갈 수 있기때문에 조금 번거롭더라고 준비를 해오시길 권장드립니다!!")
